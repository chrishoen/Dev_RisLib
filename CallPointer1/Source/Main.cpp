...
typedef Ris::CallPointer0wRet<int>                 CPRT0;
typedef Ris::CallPointer1wRet<int,int>             CPRT1;
typedef Ris::CallPointer2wRet<int,int,int>         CPRT2;
typedef Ris::CallPointer3wRet<int,int,int,int>     CPRT3;
typedef Ris::CallPointer4wRet<int,int,int,int,int> CPRT4;
