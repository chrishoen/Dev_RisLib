...
void CmdLineExec::executeGo9(Ris::CmdLineCmd* aCmd)
{
   ...
   Ris::Filter::MovingDerivative tF;
...
{
   Ris::Filter::CharacterFilter1 tF;
   tF.initialize(1.0);
