...
void main_initialize(int argc,char** argv)
{
   ...
   //***************************************************************************
   //***************************************************************************
   // Set program base directory.

   // Set the base directory for windows and linux.
   Ris::setBaseDirectoryForWindows("C:/Alpha");
   Ris::setBaseDirectoryForLinux("/opt/alpha");
