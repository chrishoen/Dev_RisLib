...
int main(int argc,char** argv)
{
   ...
   Some::gPeriodicTestThread = new Some::PeriodicTestThread;
   Some::gPeriodicTestThread->launchThread();
   ...
   Some::gPeriodicTestThread->showThreadInfo();
   ...
   Some::gPeriodicTestThread->shutdownThread();
   delete Some::gPeriodicTestThread;
   Some::gPeriodicTestThread = 0;
