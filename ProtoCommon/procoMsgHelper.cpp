...
{
   Prn::print(Prn::ThreadRun3, "TestMsg");
...
{
   Prn::print(Prn::ThreadRun3, "DataRecord");
   Prn::print(Prn::ThreadRun3, "Code1      %d", aMsg->mCode1);
   Prn::print(Prn::ThreadRun3, "Code2      %d", aMsg->mCode2);
   Prn::print(Prn::ThreadRun3, "Code3      %d", aMsg->mCode3);
   Prn::print(Prn::ThreadRun3, "Code4      %d", aMsg->mCode4);
...
{
   Prn::print(Prn::ThreadRun3, "DataMsg");
   Prn::print(Prn::ThreadRun3, "UShort    %X",    aMsg->mUShort);
   Prn::print(Prn::ThreadRun3, "UInt      %X",    aMsg->mUInt);
   Prn::print(Prn::ThreadRun3, "UInt64    %llX",  aMsg->mUInt64);
   Prn::print(Prn::ThreadRun3, "Char      %d",    aMsg->mChar);
   Prn::print(Prn::ThreadRun3, "Short     %d",    aMsg->mShort);
   Prn::print(Prn::ThreadRun3, "Int       %d",    aMsg->mInt);
   Prn::print(Prn::ThreadRun3, "Int64     %lld",  aMsg->mInt64);
   Prn::print(Prn::ThreadRun3, "Float     %f",    aMsg->mFloat);
   Prn::print(Prn::ThreadRun3, "Double    %f",    aMsg->mDouble);
   Prn::print(Prn::ThreadRun3, "Bool      %d",    aMsg->mBool);

   Prn::print(Prn::ThreadRun3, "String1   %s",    aMsg->mString1);
   Prn::print(Prn::ThreadRun3, "String2   %s",    aMsg->mString2);
