...
MonitorThread::MonitorThread()
{
   ...
   ProtoComm::MsgMetrics* tTxMsgMetrics = (ProtoComm::MsgMetrics*)gClientThread->mMsgMonkey->mTxMsgMetrics;
   ProtoComm::MsgMetrics* tRxMsgMetrics = (ProtoComm::MsgMetrics*)gClientThread->mMsgMonkey->mRxMsgMetrics;
