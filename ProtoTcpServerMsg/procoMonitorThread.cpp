...
MonitorThread::MonitorThread()
{
   ...
   ProtoComm::MsgMetrics* tTxMsgMetrics = (ProtoComm::MsgMetrics*)gServerThread->mMsgMonkey->mTxMsgMetrics;
   ProtoComm::MsgMetrics* tRxMsgMetrics = (ProtoComm::MsgMetrics*)gServerThread->mMsgMonkey->mRxMsgMetrics;
