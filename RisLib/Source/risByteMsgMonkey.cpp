...
void BaseMsgMonkey::putMsgToBuffer(Ris::ByteBuffer* aBuffer, Ris::ByteMsg* aMsg)
{
...
Ris::ByteMsg* BaseMsgMonkey::getMsgFromBuffer (Ris::ByteBuffer* aBuffer)
{
   // Guard.
   ...
   Ris::ByteMsg* aMsg = mCreator->createMsg(mMessageType);
