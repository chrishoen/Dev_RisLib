...
//  Documentation is found at http://www.codeproject.com/cpp/CallPointer.asp
//
...
//				  * Added CallPointer::empty() to test if invocation is safe (Thanks Neville Franks).
...
//				  * New syntax: CallPointer< int (char *, double) >. 
...
// An outer class, CallPointerN<>, handles the invoking and creates the
// necessary typedefs.
...
public:
	...
	typedef CallPointer0 type;

	// Construction and comparison functions
	CallPointer0() { clear(); }
	CallPointer0(const CallPointer0 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer0 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer0 &x) const {
	...
	CallPointer0(Y *pthis, DesiredRetType (X::* function_to_bind)() ) {
	...
	template < class X, class Y >
	CallPointer0(const Y *pthis, DesiredRetType (X::* function_to_bind)() const) {
	...
	CallPointer0(DesiredRetType (*function_to_bind)() ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)() ) {
		bind(function_to_bind);	}
	inline void bind(DesiredRetType (*function_to_bind)()) {
		m_Closure.bindstaticfunc(this, &CallPointer0::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer1 type;

	// Construction and comparison functions
	CallPointer1() { clear(); }
	CallPointer1(const CallPointer1 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer1 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer1 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer1 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer1 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer1(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer1(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer1(DesiredRetType (*function_to_bind)(Param1 p1) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)(Param1 p1) ) {
		bind(function_to_bind);	}
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1)) {
		m_Closure.bindstaticfunc(this, &CallPointer1::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer2 type;

	// Construction and comparison functions
	CallPointer2() { clear(); }
	CallPointer2(const CallPointer2 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer2 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer2 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer2 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer2 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer2(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer2(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer2(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2)) {
		m_Closure.bindstaticfunc(this, &CallPointer2::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer3 type;

	// Construction and comparison functions
	CallPointer3() { clear(); }
	CallPointer3(const CallPointer3 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer3 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer3 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer3 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer3 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer3(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer3(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer3(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3)) {
		m_Closure.bindstaticfunc(this, &CallPointer3::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer4 type;

	// Construction and comparison functions
	CallPointer4() { clear(); }
	CallPointer4(const CallPointer4 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer4 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer4 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer4 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer4 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer4(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer4(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer4(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
		m_Closure.bindstaticfunc(this, &CallPointer4::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer5 type;

	// Construction and comparison functions
	CallPointer5() { clear(); }
	CallPointer5(const CallPointer5 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer5 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer5 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer5 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer5 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer5(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer5(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer5(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
		m_Closure.bindstaticfunc(this, &CallPointer5::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer6 type;

	// Construction and comparison functions
	CallPointer6() { clear(); }
	CallPointer6(const CallPointer6 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer6 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer6 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer6 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer6 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer6(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer6(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer6(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) {
		m_Closure.bindstaticfunc(this, &CallPointer6::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer7 type;

	// Construction and comparison functions
	CallPointer7() { clear(); }
	CallPointer7(const CallPointer7 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer7 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer7 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer7 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer7 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer7(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer7(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer7(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)) {
		m_Closure.bindstaticfunc(this, &CallPointer7::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CallPointer8 type;

	// Construction and comparison functions
	CallPointer8() { clear(); }
	CallPointer8(const CallPointer8 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CallPointer8 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CallPointer8 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CallPointer8 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CallPointer8 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CallPointer8(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CallPointer8(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CallPointer8(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
		m_Closure.bindstaticfunc(this, &CallPointer8::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
// 
//				CallPointer<> class (Original author: Jody Hagins)
//	Allows boost::function style syntax like:
//			CallPointer< double (int, long) >
// instead of:
//			CallPointer2< int, long, double >
//
////////////////////////////////////////////////////////////////////////////////

#ifdef FASTDELEGATE_ALLOW_FUNCTION_TYPE_SYNTAX

// Declare CallPointer as a class template.  It will be specialized
...
template<typename R>
class CallPointer< R (  ) >
  // Inherit from CallPointer0 so that it can be treated just like a CallPointer0
  : public CallPointer0 < R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer0 < R > BaseType;

  // Allow users access to the specific type of this delegate.
  typedef CallPointer SelfType;

  // Mimic the base class constructors.
  CallPointer() : BaseType() { }
  ...
  template < class X, class Y >
  CallPointer(const Y *pthis,
      R (X::* function_to_bind)(  ) const)
    : BaseType(pthis, function_to_bind)
  {  }

  CallPointer(R (*function_to_bind)(  ))
...
//N=1
// Specialization to allow use of
// CallPointer< R ( Param1 ) >
// instead of 
// CallPointer1 < Param1, R >
template<typename R, class Param1>
class CallPointer< R ( Param1 ) >
  // Inherit from CallPointer1 so that it can be treated just like a CallPointer1
  : public CallPointer1 < Param1, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer1 < Param1, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
//N=2
// Specialization to allow use of
// CallPointer< R ( Param1, Param2 ) >
// instead of 
// CallPointer2 < Param1, Param2, R >
template<typename R, class Param1, class Param2>
class CallPointer< R ( Param1, Param2 ) >
  // Inherit from CallPointer2 so that it can be treated just like a CallPointer2
  : public CallPointer2 < Param1, Param2, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer2 < Param1, Param2, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1, Param2 p2 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
//N=3
// Specialization to allow use of
// CallPointer< R ( Param1, Param2, Param3 ) >
// instead of 
// CallPointer3 < Param1, Param2, Param3, R >
template<typename R, class Param1, class Param2, class Param3>
class CallPointer< R ( Param1, Param2, Param3 ) >
  // Inherit from CallPointer3 so that it can be treated just like a CallPointer3
  : public CallPointer3 < Param1, Param2, Param3, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer3 < Param1, Param2, Param3, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1, Param2 p2, Param3 p3 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
//N=4
// Specialization to allow use of
// CallPointer< R ( Param1, Param2, Param3, Param4 ) >
// instead of 
// CallPointer4 < Param1, Param2, Param3, Param4, R >
template<typename R, class Param1, class Param2, class Param3, class Param4>
class CallPointer< R ( Param1, Param2, Param3, Param4 ) >
  // Inherit from CallPointer4 so that it can be treated just like a CallPointer4
  : public CallPointer4 < Param1, Param2, Param3, Param4, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer4 < Param1, Param2, Param3, Param4, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1, Param2 p2, Param3 p3, Param4 p4 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
//N=5
// Specialization to allow use of
// CallPointer< R ( Param1, Param2, Param3, Param4, Param5 ) >
// instead of 
// CallPointer5 < Param1, Param2, Param3, Param4, Param5, R >
template<typename R, class Param1, class Param2, class Param3, class Param4, class Param5>
class CallPointer< R ( Param1, Param2, Param3, Param4, Param5 ) >
  // Inherit from CallPointer5 so that it can be treated just like a CallPointer5
  : public CallPointer5 < Param1, Param2, Param3, Param4, Param5, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer5 < Param1, Param2, Param3, Param4, Param5, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
//N=6
// Specialization to allow use of
// CallPointer< R ( Param1, Param2, Param3, Param4, Param5, Param6 ) >
// instead of 
// CallPointer6 < Param1, Param2, Param3, Param4, Param5, Param6, R >
template<typename R, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6>
class CallPointer< R ( Param1, Param2, Param3, Param4, Param5, Param6 ) >
  // Inherit from CallPointer6 so that it can be treated just like a CallPointer6
  : public CallPointer6 < Param1, Param2, Param3, Param4, Param5, Param6, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer6 < Param1, Param2, Param3, Param4, Param5, Param6, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
//N=7
// Specialization to allow use of
// CallPointer< R ( Param1, Param2, Param3, Param4, Param5, Param6, Param7 ) >
// instead of 
// CallPointer7 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, R >
template<typename R, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7>
class CallPointer< R ( Param1, Param2, Param3, Param4, Param5, Param6, Param7 ) >
  // Inherit from CallPointer7 so that it can be treated just like a CallPointer7
  : public CallPointer7 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer7 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
//N=8
// Specialization to allow use of
// CallPointer< R ( Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8 ) >
// instead of 
// CallPointer8 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, R >
...
class CallPointer< R ( Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8 ) >
  // Inherit from CallPointer8 so that it can be treated just like a CallPointer8
  : public CallPointer8 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CallPointer8 < Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, R > BaseType;
  ...
  CallPointer(R (*function_to_bind)( Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
CallPointer0<FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)()) { 
	return CallPointer0<FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class RetType>
CallPointer0<FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)() const) { 
	return CallPointer0<FASTDLGT_RETTYPE>(x, func);
}

//N=1
template <class X, class Y, class Param1, class RetType>
CallPointer1<Param1, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1)) { 
	return CallPointer1<Param1, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class RetType>
CallPointer1<Param1, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1) const) { 
	return CallPointer1<Param1, FASTDLGT_RETTYPE>(x, func);
}

//N=2
template <class X, class Y, class Param1, class Param2, class RetType>
CallPointer2<Param1, Param2, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2)) { 
	return CallPointer2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class RetType>
CallPointer2<Param1, Param2, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2) const) { 
	return CallPointer2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
}

//N=3
template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
CallPointer3<Param1, Param2, Param3, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3)) { 
	return CallPointer3<Param1, Param2, Param3, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
CallPointer3<Param1, Param2, Param3, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3) const) { 
	return CallPointer3<Param1, Param2, Param3, FASTDLGT_RETTYPE>(x, func);
}

//N=4
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class RetType>
CallPointer4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) { 
	return CallPointer4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class RetType>
CallPointer4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const) { 
	return CallPointer4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>(x, func);
}

//N=5
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class RetType>
CallPointer5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) { 
	return CallPointer5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class RetType>
CallPointer5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) const) { 
	return CallPointer5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>(x, func);
}

//N=6
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType>
CallPointer6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) { 
	return CallPointer6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType>
CallPointer6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) const) { 
	return CallPointer6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE>(x, func);
}
...
CallPointer7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)) { 
	return CallPointer7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class RetType>
CallPointer7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) const) { 
	return CallPointer7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(x, func);
}
...
CallPointer8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8)) { 
	return CallPointer8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class Param8, class RetType>
CallPointer8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) const) { 
	return CallPointer8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE>(x, func);
}
