#ifndef _RIS_CONTAINERS_H_
#define _RIS_CONTAINERS_H_

/*==============================================================================

Containers, documentation is at end of file
...
template <class Element,int NumOfElements>
class  Queue
{
public:
   ...
   Element mElement[NumOfElements+1];
   
//******************************************************************************
// These reset member variables.
...
//******************************************************************************
//******************************************************************************
// class template Stack <Element,NumOfElements>
//
...
// The structure has the following members:
//******************************************************************************
// This is the number of elements allocated for the stack. It is the number of
// elements to which memory is allocated
// 
//    Allocate = NumOfElements
//    allocated storage = Allocate*ElementSize
//
//******************************************************************************
// This is the array index of the top of the stack, where push and pop
...
public:
   ...
   Element mElement[NumOfElements];
...
// These reset member variables.
   ...
   void reset ()
   {
      mAllocate = NumOfElements;
      mIndex = 0;
   }

//******************************************************************************
// This returns true if stack push operations are allowed. This is the same as
// "is not full".

   bool isPush ()
   {
      return mIndex != mAllocate;
   }
   
//******************************************************************************
// This pushes an element to the stack and advances the index. It does a copy 
// from a source element into the queue array element at the index. Note that
// the source element must be of element size.

   void push (Element& aElement)
   {
...
//******************************************************************************
// This returns a pointer to the current stack element to push to. It is
// provided to give direct access to the element to minimize copies. If an 
// element is copied directly to the stack using this pointer then nextPush 
// should be called after the copy operation.

   Element& elementToPush ()
   {
      return mElement[mIndex];
   }

//******************************************************************************
// This is executed after a push operation to increment the stack index.
...
//******************************************************************************
// This returns true if stack pop operations are allowed. This is the same as
// "is not empty".
...
//******************************************************************************
// This pops an element from the stack and advances the index. It does a copy 
// from the queue array element at the index - 1 into a desination element. 
// Note that the destination element must be of element size.

   void pop(Element& aElement)
   {
      //Copy the element above the stack index into the destination
      aElement = mElement[mIndex - 1];
      // Decrement the index
      --mIndex;
   }

//******************************************************************************
// This returns a pointer to the current stack element to pop from. It is 
// provided to give direct access to the element to minimize copies. If an 
// element is copied directly from the stack using this pointer then nextPop
// should be called after the copy operation.

   Element& elementToPop ()
   {
      return mElement[mIndex - 1];
   }

//******************************************************************************
// This is executed after a get operation to decrement the stack index.
...
//******************************************************************************
// This is the current size of the stack. 
...
//******************************************************************************
//******************************************************************************
// class template Allocator <NumOfElements>
...
public:
   ...
   void reset ()
   {
      Stack<int,NumOfElements>::reset();
      for(int token=NumOfElements-1;token>=0;--token) BaseClass::push(token);  
   }
};
}//namespace
}//namespace
...
In the followinng example M=4,A=4
