...
class SppParms : public Ris::BaseCmdLineParms
{
public:
   ...
   //***************************************************************************
   //***************************************************************************
   // Members. Read from parameters file.

   // Remote device name.
   char mRemoteName[cMaxStringSize];
...
#ifdef _PROCOSPPPARMS_CPP_
   SppParms gSppParms;
#else
   extern SppParms gSppParms;
#endif
