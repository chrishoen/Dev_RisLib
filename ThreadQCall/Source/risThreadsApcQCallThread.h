#ifndef _RISTHREADSAPCQCALLTHREAD_H_
#define _RISTHREADSAPCQCALLTHREAD_H_
...
class BaseApcQCallThread : public Ris::Threads::BaseThread,public BaseBaseQCallThread
{
public:
   BaseApcQCallThread();
