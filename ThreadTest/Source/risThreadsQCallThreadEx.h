#ifndef _RISTHREADSQCALLTHREADEX_H_
#define _RISTHREADSQCALLTHREADEX_H_
...
#include "risThreadsQCallThreadBase.h"
...
class BaseQCallThreadEx : public Ris::Threads::BaseThread,public BaseBaseQCallThread
{
public:
   BaseQCallThreadEx();
  ~BaseQCallThreadEx();
